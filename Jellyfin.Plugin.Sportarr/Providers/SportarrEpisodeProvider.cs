    ...
    public class SportarrEpisodeProvider : IRemoteMetadataProvider<Episode, EpisodeInfo>, IHasOrder
    {
        ...
        public async Task<MetadataResult<Episode>> GetMetadata(EpisodeInfo info, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var url = $"{ApiUrl}/api/v1/metadata/series/{seriesId}/season/{info.ParentIndexNumber}/episodes";
                ...
                if (json.RootElement.TryGetProperty("episodes", out var episodes))
                {
                    ...
                    {
                        if (ep.TryGetProperty("episodeNumber", out var epNum) &&
                            epNum.GetInt32() == info.IndexNumber.Value)
                        {
                            ...
                            // Air date
                            if (ep.TryGetProperty("airDate", out var airDate) &&
                            ...
                            // Duration
                            if (ep.TryGetProperty("durationMinutes", out var duration) &&
                            ...
                            if (ep.TryGetProperty("partName", out var partName) &&
